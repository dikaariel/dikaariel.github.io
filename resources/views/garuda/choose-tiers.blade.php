...
<body>
    <div id="Background" class="absolute top-0 w-full h-[810px] bg-[linear-gradient(180deg,#85C8FF_0%,#D4D1FE_47.05%,#F3F6FD_100%)]">
        <img src="/garuda/assets/images/backgrounds/Jumbo Jet Sky (1) 1.png" class="absolute right-0 top-[147px] object-contain max-h-[481px]" alt="background image">
    </div>
    ...
    @php
        ...
        $businessPrice = $flight->price + 2000000;
    ...
    <main class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]">
        <a href="/available-flights" class="flex items-center rounded-[50px] py-3 px-5 gap-[10px] w-fit bg-garuda-black">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-[10px]">
                                <img src="/garuda/assets/images/logos/ana.svg" class="w-[60px] h-[60px] flex shrink-0" alt="logo">
            ...
            <div id="Tiers" class="grid grid-cols-2 gap-x-[30px]">
                <div id="Economy" class="flex flex-col h-fit rounded-[20px] p-5 pb-[30px] gap-5 bg-white">
                    <div class="w-[260px] h-[180px] rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                        <img src="/garuda/assets/images/thumbnails/economy-seat.png" class="w-full h-full object-cover" alt="thumbnails">
                    </div>
                    ...
                    <div class="flex items-center gap-[10px]">
                        <img src="/garuda/assets/images/icons/electricity-black.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                        <p class="font-semibold">USB C Port</p>
                    </div>

                    <div class="flex items-center gap-[10px]">
                        <img src="/garuda/assets/images/icons/security-user-black.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                        <p class="font-semibold">Lifeguard</p>
                    </div>

                    <a href="{{ route('booking.seats', $flight->id) }}?tier=economy&quantity={{ $quantity }}"
                ...
                <div id="Business" class="flex flex-col h-fit rounded-[20px] p-5 pb-[30px] gap-5 bg-white">
                    <div class="w-[260px] h-[180px] rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                        <img src="/garuda/assets/images/thumbnails/business-seat.png" class="w-full h-full object-cover" alt="thumbnails">
                    </div>
                    ...
                    <div class="flex items-center gap-[10px]">
                        <img src="/garuda/assets/images/icons/coffee-black.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <div class="flex items-center gap-[10px]">
                        <img src="/garuda/assets/images/icons/video-play-black.svg" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <a href="{{ route('booking.seats', $flight->id) }}?tier=business&quantity={{ $quantity }}"
                        class="w-full rounded-full py-3 px-5 text-center bg-garuda-blue hover:shadow-[0px_14px_30px_0px_#0068FF66] transition-all duration-300">
                        <span class="font-semibold text-white">Choose</span>
                    </a>
                </div>
